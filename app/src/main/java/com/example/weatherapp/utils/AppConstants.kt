...
object AppConstants {
    const val CITY = "sofia"
    const val SOFIA_LAT = "42.698334"
    const val SOFIA_LON = "23.319941"
    ...
    const val SPEED_METRIC = "m/s"
    const val SPEED_IMPERIAL = "m/s"
    const val SPEED_STANDARD = "km/h"
